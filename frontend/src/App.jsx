...
export default function App() {
  ...
  const removeFromCart = (productId) => setCartItems(prev => prev.filter(p => p._id !== productId));

  const handlePlaceOrder = async (shippingAddress = { address: "N/A", city: "", postalCode: "", country: "" }) => {
    ...
    <div className="app">
      ...
      <main className="container">
        <Routes>
          ...
          <Route path="/cart" element={<CartPage items={cartItems} onRemove={removeFromCart} onPlaceOrder={handlePlaceOrder} />} />
        </Routes>
      </main>
    </div>
  );
